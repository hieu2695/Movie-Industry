...
fil_col = c("darkturquoise", "firebrick1", "deepskyblue3","goldenrod1","deeppink2","yellowgreen")

# plot the number of movies by company using ggplot()
ggplot(comp_count, aes(x = reorder(Var1, Freq), y = Freq, fill = Var1)) +  # order by the number of movies
  geom_bar(stat = 'identity', fill = fil_col, alpha = 0.9) + coord_flip() +
  ylab("Number of movies") +
  xlab("Studios") +
  ggtitle(("Number of movies by companies")) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5)) +
  guides(fill=guide_legend(title = "Studios"))
...
fil_col = c("mediumspringgreen","goldenrod1", "indianred1","dodgerblue2")

ggplot(season_count, aes(x = Var1, y = Freq, fill = Var1)) + 
  geom_bar(stat = 'identity', fill=fil_col, alpha = 0.8) +
  ylab("Number of movies") +
  xlab("Season") +
...
ggplot(genres_count, aes(x = reorder(Var1, Freq), y = Freq, fill = Var1)) + 
...
corrplot.mixed(cordf) # correlation plot
