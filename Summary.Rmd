...
MAE - train| `r rev_lm_metrics_train3[c(1)]`| `r metrics_train_tree[c(1)]`| `r format(metrics_train_rf1[c(1)], digits = 2)`|
MAE - test| `r rev_lm_metrics_test3[c(1)]`| `r metrics_test_tree[c(1)]`| `r format(metrics_test_rf1[c(1)], digits = 2)`|
RMSE - train| `r rev_lm_metrics_train3[c(3)]`| `r metrics_train_tree[c(3)]`| `r format(metrics_train_rf1[c(3)], digits = 2)`|
RMSE - test| `r rev_lm_metrics_test3[c(3)]`| `r metrics_test_tree[c(3)]`| `r format(metrics_test_rf1[c(3)], digits = 2)`|
