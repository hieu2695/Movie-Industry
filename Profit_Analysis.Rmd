...
regressor = randomForest(x = movies_rf[-9],
                         y = movies_rf$profit,
                         ntree = 500)
...
Mulan <- data.frame(company = 'Walt Disney',genre = 'Animation',month = 3, runtime = 100 ,budget = 25000000, popularity = 150, score = 9.4,vote = 4566)
...
Frozen2 <- data.frame(company = 'Walt Disney',genre = 'Animation',month = 11, runtime = 104 ,budget = 33000000, popularity = 150, score = 4.58,vote = 29223)
levels(Frozen2$company) <- regressor$forest$xlevels$company
levels(Frozen2$genre) <- regressor$forest$xlevels$genre
Frozen2_profit = predict(regressor, Frozen2)
#651000000
#521197933 
```