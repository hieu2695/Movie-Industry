...
movie_OH$month <- as.factor(movie_OH$month)
...
```
Here, we see that the lowest MSE is when $\lambda$ appro = . It has  non-zero coefficients. 
...
Frozen_profit = predict(RFregressor, Frozen)
